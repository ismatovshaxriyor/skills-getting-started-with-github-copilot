...
activities = {
    = {
        ...
        "Swimming Squad": {
            "description": "Swim practice and competitive meets for all levels",
        ...
        "Drama Society": {
            "description": "Rehearse scenes, develop performances, and put on plays",
        ...
        "Debate Team": {
            "description": "Develop public speaking and critical reasoning skills",
